  ...
  // ──────────────── 2. Equivalent Ratios & Unit Rates ────────────────
  {
    ...
    sections: [
      ...
      { kind: "WORKED_EXAMPLES", title: "Worked examples", content: { examples: [
        ...
        { title: "Better deal", problem: "Is $4 for 2 litres or $9 for 3 litres cheaper per litre?", steps: ["First: $4 \\div 2 = \\$2$/L.", "Second: $9 \\div 3 = \\$3$/L.", "$2 < 3$."], answer: "$4 for 2 litres is the better deal." },
      ] } },
    ...
    questions: [
      ...
      { scope: "PRACTICE", kind: "NUMERIC", prompt: "$6 for 3 pounds. Unit price in dollars per pound?", answer: { value: 2, tolerance: 0 }, hint: "Divide $6 by 3.", explanation: "$6/3 = \\$2$/lb." },
